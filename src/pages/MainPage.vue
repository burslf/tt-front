  ...
  <q-page class="flex row">
    <div class="q-px-lg q-pt-xl col-12 col-md-6">
      ...
      <p class="text-subtitle1">
        An NFT event ticketing marketplace helping artists foster closer connections with fans, eliminating fraud and
        reducing the impact of scalping.
      </p>
      <div class="buttons">
        <q-btn class="q-mx-lg q-my-sm" push no-caps color="secondary" label="Get Started" />
        <q-btn class="q-mx-lg q-my-sm" push no-caps color="primary" label="Create" />
      </div>
    </div>

    <div class="flex col-12 col-md-6 justify-center">
      <div v-if="exploreCards.length > 0" class="flex items-start justify-around q-pa-sm">
        <RaiseCapitalCard v-for="(card, index) in cardsToDisplay" :key="index"
